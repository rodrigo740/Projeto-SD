...
/**
 * Parametric stack derived from a parametric memory. Errors are reported.
 *
...
public class MemStack<R> extends MemObject<R> {
	...
	/**
	 * Stack instantiation. The instantiation only takes place if the memory exists.
	...
	/**
	 * Stack push. A parametric object is written into it. If the stack is full, an
	 * error is reported.
	 *
	...
	/**
	 * Stack pop. A parametric object is read from it. If the stack is empty, an
	 * error is reported.
	 *
